...
//#define DEBUG_FUNCTION_PTR_ALIASING
    ...
    bool PointsToUtils::getTargetFunctions(GlobalState &currState, std::vector<std::pair<Instruction *,Function*> > *currFuncCallSites,
    ...
    bool PointsToUtils::getAllAliasObjects(GlobalState &currState, std::vector<std::pair<Instruction *,Function*> > *currFuncCallSites,
                            Value *srcPointer,
