...
namespace DRCHECKER {
    ...
    public:
        ...
        std::vector<std::pair<Instruction *,Function*> > *currFuncCallSites1;
        FunctionChecker *targetChecker;

        ImproperTaintedDataUseDetector(GlobalState &targetState, Function *toAnalyze,
                std::vector<std::pair<Instruction *,Function*> > *srcCallSites, FunctionChecker *currChecker): currState(targetState) {
