...
namespace DRCHECKER {
    ...
    public:
        ...
        void printTaintResults(llvm::raw_ostream& O) const;
    ...
    private:
         ...
         * @return indicating if there is any taint parameters
         */
        std::vector<int> setupCallContext(CallInst &I, Function *currFunction, std::vector<std::pair<Instruction *,Function*> > *newCallContext);
