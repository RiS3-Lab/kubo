...
namespace DRCHECKER {
    ...
    public:
         ...
         */
        static bool getTargetFunctions(GlobalState &currState, std::vector<std::pair<Instruction *,Function*> > *currFuncCallSites,
         ...
         * @return
         */
        static bool getAllAliasObjects(GlobalState &currState, std::vector<std::pair<Instruction *,Function*> > *currFuncCallSites,
                                       Value *srcPointer,
