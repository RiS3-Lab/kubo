...
namespace DRCHECKER {
    ...
    public:
        ...
        virtual VisitorCallback* visitCallInst(CallInst &I, Function *targetFunction,
                                               ...
                                               std::vector<std::pair<Instruction *,Function*> > *currFuncCallSites,
                                               std::map<Function*,std::vector<int> > * globalTaint,std::vector<Function*>* targetFuncs,FunctionTaintSummary*);
    ...
    private:
         ...
         */
        void setupCallContext(CallInst &I, Function *currFunction, std::vector<std::pair<Instruction *,Function*> > *newCallContext);
