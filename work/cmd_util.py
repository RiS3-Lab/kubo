...
def CMDLinker():
    ...
    '''
    #llvm 9.0 newly encountered linker options
    grouper.add_argument("-shared", action="store_true")
    grouper.add_argument("--hash-style",type=str)
    grouper.add_argument("--eh-frame-hdr",action="store_true")
    grouper.add_argument("-Bsymbolic",action="store_true")
    grouper.add_argument("-soname",type=str)
    '''
    # src files
